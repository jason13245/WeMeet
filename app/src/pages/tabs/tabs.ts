...
export class TabsPage {
  ...
  ionViewDidLoad() {
    ...
    this.setEventLinkRegulation(this.eventData);
    this.inviteLink = this.generateEventLink(this.eventData);
    this.presentProfileModal();
  }

  generateEventLink(eventData) {
    console.log(eventData);
    return 'wemeet://wemeet.space/event/' + eventData.eventData.url;
  }
